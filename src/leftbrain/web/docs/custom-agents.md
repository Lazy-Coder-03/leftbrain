...
:::response
```text
tools: ['math', 'datetime', 'scale', 'convert', 'holidays', 'numbers', 'finance', 'text', 'collections', 'validate', 'random', 'geo_offline', 'encode']
