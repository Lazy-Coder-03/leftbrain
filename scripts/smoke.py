...
TESTS = [
    ...
    ("math integrate", lambda: lb.math_tool("integrate", expr="x^2", lower=0, upper=3)),
    ("math limit", lambda: lb.math_tool("limit", expr="sin(x)/x", point=0)),
    ...
    ("math polar", lambda: lb.math_tool("convert_form", expr="3+4i", form="polar")),
    ...
    ("dt diff", lambda: lb.datetime_tool("diff", start="2024-02-29", end="2026-08-26")),
    ...
    ("dt bdays", lambda: lb.datetime_tool("business_days", region="IN", start="2026-10-01", end="2026-10-31")),
    ...
    ("dt cron", lambda: lb.datetime_tool("cron_next", expr="0 9 * * 1-5", tz="Asia/Kolkata", n=3, start="2026-08-28T10:00")),
    ...
    ("geo dist", lambda: lb.geo_tool("distance", origin="Kolkata", destination="London")),
